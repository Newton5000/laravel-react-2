const ErrorPage = ({ status }) => {
    ...
    return (
        <>
            <div className="bg-gray-100 min-h-screen justify-center p-2 sm:p-24">
                <center className="m-auto">
                    {/*slow this animation down*/}
                    <svg className="emoji-404 delay-100 animate-bounce" enableBackground="new 0 0 226 249.135" height="249.135" id="Layer_1"
                    ...
                    <div className=" tracking-widest mt-4">
                        <span className="text-gray-500 text-6xl block">{ status } <span></span></span>
